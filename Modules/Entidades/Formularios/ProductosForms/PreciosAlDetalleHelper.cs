...
{
    public partial class PreciosAlDetalleHelper : MaterialForm
    {
        private Producto producto;
        public PreciosAlDetalleHelper(ProductoMostrarDto producto)
        {
            InitializeComponent();
            ...
            this.producto = ProductoMapper.DeProductoMostrarVentaAProducto(producto.Id);
        }

        private void PreciosAlDetalleHelper_Load(object sender, EventArgs e)
        {
